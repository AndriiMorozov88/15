...
function getPossibleTurnIndex(index) {
...
function showArray() {
    ...
    getPossibleTurnIndex(indexNull).forEach((element) => {
    ...
    gameElement.addEventListener('click', () => {
        if (gameElement.classList.contains('game-element--possible') && start === true) {
            ...
            if (checkWinCombination()) {
                ...
                start = null;
                getPossibleTurnIndex(indexNull).forEach((element) => {
                    document.getElementById(element).classList.remove('game-element--possible');
                    document.getElementById(indexNull).classList.remove('game-element--null');
                });
            }
        } else if (start === false) {
            let flashColor = [
